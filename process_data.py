...
def get_sqlite_table(date_i,reference_time):
...
def upsert_to_sqlite(purchase_i,datetime_i,reference_time):
    ...
    # reference_time.
    table, _ = get_sqlite_table(datetime_i.date(),reference_time)
...
def bulk_upsert_to_sqlite(purchases,dts,date_i,reference_time):
    ...
    table, db = get_sqlite_table(filing_date,reference_time)
...
def bulk_insert_into_sqlite(purchases,dts,date_i,reference_time):
    ...
    sample_date = parser.parse(sample_date_string).date()
    assert filing_date == sample_date
    table, _ = get_sqlite_table(filing_date,reference_time)
